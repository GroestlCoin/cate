...
/**
 * A class that exposes relevant groestlcoin stuff as JavaFX bindable properties.
 */
public class GroestlcoinUIModel {
    ...
    public GroestlcoinUIModel() {
    }

    public GroestlcoinUIModel(Wallet wallet) {
        setWallet(wallet);
    }
